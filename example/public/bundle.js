...
var app = (function () {
    ...
    var unsplash1 = {
                ...
                src: 'unsplash-1.e7946b7d64b33565.jpg',
                width: 6720,
                height: 4480
            };
    ...
    var unsplash2 = {
                ...
                src: 'unsplash-2.4f59456198c9aaa3.jpg',
                width: 2765,
                height: 3456
            };
    ...
    function create_fragment(ctx) {
    	var div1, div0, t0, img0, img0_src_value, t1, img1, img1_src_value, dispose;
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file, 40, 2, 861);
    			attr(img0, "class", "placeholder svelte-1q5dsg3");
    			attr(img0, "src", img0_src_value = ctx.image.placeholder);
    			attr(img0, "alt", ctx.alt);
    			toggle_class(img0, "shown", !ctx.loaded);
    			add_location(img0, file, 41, 2, 893);
    			attr(img1, "src", img1_src_value = ctx.image.src);
    			attr(img1, "alt", ctx.alt);
    			attr(img1, "class", "svelte-1q5dsg3");
    			toggle_class(img1, "shown", ctx.loaded);
    			add_location(img1, file, 42, 2, 976);
    			attr(div1, "class", "" + null_to_empty(ctx.containerClass) + " svelte-1q5dsg3");
    			attr(div1, "style", ctx.style);
    			add_location(div1, file, 39, 0, 821);
    			dispose = listen(img1, "load", ctx.load_handler);
    		},
    		...
    		p: function update(changed, ctx) {
    			...
    			if ((changed.image) && img0_src_value !== (img0_src_value = ctx.image.placeholder)) {
    			...
    			if ((changed.image) && img1_src_value !== (img1_src_value = ctx.image.src)) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			div0 = element("div");
    			image3.$$.fragment.c();
    			add_location(h10, file$1, 31, 1, 569);
    			add_location(h11, file$1, 33, 1, 619);
    			attr(div0, "class", "bigImage svelte-dfg9qb");
    			add_location(div0, file$1, 37, 2, 721);
    			attr(div1, "class", "grid svelte-dfg9qb");
    			add_location(div1, file$1, 34, 1, 640);
    			attr(div2, "class", "container svelte-dfg9qb");
    			add_location(div2, file$1, 30, 0, 544);
    		},
